 ...
 */
@Repository
public class WbPromotionNormQueryStatisticsRepositoryImpl implements WbPromotionNormQueryStatisticsRepositoryCustom {
    ...
    public List<WbPromotionNormQueryStatisticsRepository.NormQueryClusterAggregateRow> findAggregatedClustersPage(
            Long campaignId,
            LocalDate dateFrom,
            LocalDate dateTo,
            Long nmId,
        ...
        List<WbPromotionNormQueryStatisticsRepository.NormQueryClusterAggregateRow> rows = new ArrayList<>(raw.size());
        for (Object[] row : raw) {
    ...
    @Override
    public WbPromotionNormQueryStatisticsRepository.NormQueryClusterTotalsRow findTotalsByCampaignAndPeriod(
            Long campaignId,
            LocalDate dateFrom,
            LocalDate dateTo,
            Long nmId,
    ...
    private static final class AggregateRowProjection
            implements WbPromotionNormQueryStatisticsRepository.NormQueryClusterAggregateRow {
    ...
    private static final class TotalsRowProjection
            implements WbPromotionNormQueryStatisticsRepository.NormQueryClusterTotalsRow {
