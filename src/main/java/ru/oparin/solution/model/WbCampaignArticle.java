 ...
 */
@Entity
@Table(name = "wb_campaign_articles", schema = "solution")
...
@NoArgsConstructor
@AllArgsConstructor
@IdClass(WbCampaignArticleId.class)
public class WbCampaignArticle {
    ...
    private WbPromotionCampaign campaign;
    ...
    private WbProductCard productCard;
