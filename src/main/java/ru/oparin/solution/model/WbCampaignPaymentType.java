 ...
 */
public enum WbCampaignPaymentType {
    /** Оплата за показы. */
    CPM,
     ...
     */
    public static WbCampaignPaymentType fromApiValue(String value) {
        if (value == null || value.isBlank()) {
            return null;
        }
        try {
            return WbCampaignPaymentType.valueOf(value.trim().toUpperCase());
