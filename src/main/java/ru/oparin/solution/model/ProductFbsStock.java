 ...
 */
@Entity
@Table(name = "product_fbs_stocks", schema = "solution",
...
public class ProductFbsStock {
    ...
    /**
     * Артикул WB (nmID), если размер найден в {@link ProductBarcode}.
     */
    @Column(name = "nm_id")
    private Long nmId;
    ...
    /**
     * Баркод (sku) из ответа WB или из {@link ProductBarcode}.
     */
