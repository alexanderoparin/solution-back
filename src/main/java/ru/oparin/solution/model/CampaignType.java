 ...
 * - Тип 8: Единая ставка (в API WB — автоматическая РК, /adv/v1/promotion/adverts)
 * - Тип 9: Ручная ставка (в API WB — аукцион, /adv/v0/auction/adverts)
 * 
