 ...
 * Сохраняется из информации о карточке товара (WbCardDto.Size).
 * Баркод является уникальным ключом.
 */
@Entity
@Table(name = "wb_product_barcodes", schema = "solution")
...
@NoArgsConstructor
@AllArgsConstructor
public class WbProductBarcode {

    /**
     * Баркод товара (из массива skus в WbCardDto.Size).
     * Первичный ключ.
     */
    @Id
