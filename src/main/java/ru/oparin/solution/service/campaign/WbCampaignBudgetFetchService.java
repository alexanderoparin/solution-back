...
public class WbCampaignBudgetFetchService {
     ...
     */
    public Optional<Integer> fetchBudgetForDecision(Cabinet cabinet, Long advertId, WbCampaignManagementState state) {
     ...
     */
    public Optional<Integer> fetchBudgetForSlotEnter(Cabinet cabinet, Long advertId, WbCampaignManagementState state) {
    ...
    private Optional<Integer> fetchBudgetTotalInternal(
        ...
        try {
            WbPromotionBudgetResponse budget = promotionApiClient.getCampaignBudget(cabinet.getApiKey(), advertId);
    ...
    private Optional<Integer> cachedBudget(WbCampaignManagementState state) {
    ...
    private Optional<Integer> todayCachedBudget(WbCampaignManagementState state) {
        if (state == null
     ...
     */
    private Optional<Integer> freshCachedBudget(WbCampaignManagementState state, CabinetTokenType tokenType) {
        if (state == null
                || state.getLastBudgetTotal() == null
     ...
     */
    private boolean isBudgetCacheFromPreviousDay(WbCampaignManagementState state) {
