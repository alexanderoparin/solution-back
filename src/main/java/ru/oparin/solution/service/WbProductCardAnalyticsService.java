...
@Slf4j
public class WbProductCardAnalyticsService {
    ...
    private final WbPromotionCampaignSyncService campaignSyncService;
    ...
    private void doUpdateCabinetAnalytics(
        ...
        try {
            ...
            List<WbProductCard> productCards = productCardService.findByCabinetId(cabinetId);
    ...
    private void syncCards(Cabinet managed, String apiKey) {
        WbCardsListResponse cardsResponse = wbCardsSyncService.fetchAllCards(apiKey);
    ...
    private void syncAnalytics(Cabinet managed, long cabinetId, List<WbProductCard> productCards,
                               LocalDate dateFrom, LocalDate dateTo) {
        String apiKey = managed.getApiKey();
        WbProductCardAnalyticsLoadService.ProcessingResult result =
    ...
    private List<Long> collectNmIds(List<WbProductCard> productCards) {
    ...
    private List<Long> collectNmIdsFromCabinet(long cabinetId) {
        List<WbProductCard> cards = productCardService.findByCabinetId(cabinetId);
