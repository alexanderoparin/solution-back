...
@Slf4j
public class WbAbTestStartEventExecutor implements WbApiEventExecutor {
    ...
    public WbApiEventExecutionResult execute(WbApiEvent event) {
        WbAbTestStartPayload payload = eventService.readPayload(event, WbAbTestStartPayload.class);
    ...
    private WbApiEventExecutionResult failStartDueToToken(Long abTestId, Throwable cause) {
        String message = WbAbTestService.TOKEN_CONTENT_WRITE_REQUIRED;
